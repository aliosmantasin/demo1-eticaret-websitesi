...
export function CartButton({ count: propCount = 0 }: CartButtonProps) {
    const [cartCount, setCartCount] = React.useState(propCount);
    ...
    return (
        <button className="flex items-center justify-center gap-2 md:h-12 md:w-32 md:rounded-lg md:bg-[#919191] md:px-4 md:hover:bg-gray-600 cursor-pointer text-white">
